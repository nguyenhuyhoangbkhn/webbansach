...
class NxbController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Nxb');
	...
	{
		$model=new Nxb('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Nxb']))
			$model->attributes=$_GET['Nxb'];
	 ...
	 * @param Nxb $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='nxb-form')
		{
